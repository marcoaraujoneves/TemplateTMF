    ...
    <main>
        <section id="secaoProdutos" class="secaoSite" style="margin-top:110px;" >
                ...
                <div class="row">
                    <div class="col-md-12 container-titulos pb-2">
                        <p style="text-align:center">
                            Veja aqui os produtos disponíveis pela TMF!
                        </p>
                    </div>
                </div>
            </div>
            ...
            foreach($rows as $row){
                ...
                echo '<div id="rg-gallery'.$contadorProdutos.'" class="rg-gallery">';
                ...
                $query_select = "SELECT nome from imagemproduto where codProduto = '$codProduto';";
                $result_select = mysqli_query($conn,$query_select) or die(mysql_error());
                $linhas = array();
                ...
                foreach($linhas as $linha){
                    ...
                    echo '<li><a href="#"><img src="sistema/Img/Produtos/'.$nomeImagem.' " data-large="sistema/Img/Produtos/'.$nomeImagem.'  " data-description="" /></a></li>';
                }
                echo '</ul>';
                echo '</div>';
                echo '</div>';
