...
<div  class="modal fade" id="modificarProduto"  tabindex="-1" role="dialog" aria-labelledby="modalModificarProdutoTitle" aria-hidden="true">
					<div class="modal-dialog modal-dialog-centered" role="document">
						<div class="modal-content">
							<div class="modal-header" style="background-color: rgb(8, 21, 43);color: white;">
								<h5 class="modal-title">Modificar Produto:</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
									<span aria-hidden="true">&times;</span>
								</button>
							</div>
							<div class="modal-body">
								<form method="post" enctype="multipart/form-data"  id="formProdutoModifica" >
								...
								<div class="modal-footer">
									<input type="hidden" name="modificacodigoProduto" id="modificacodigoProduto" >
									<input type="submit" class="btn btn-success" id="modificapotato" name="modificapotato" value="Cadastrar"/>
