...
//echo $query_select;
        ...
        foreach($rows as $row){ 
            ...
            $resulta = unlink('../../Img/Servicos/'.$row['nome']);
        }
...
if($resultado && $resulta && $resultad ){
            echo json_encode(array('status' => 'success','message'=> 'Serviço deletado'));
        }else{
            echo json_encode(array('status' => 'error','message'=> 'Erro ao deletar serviço'));
