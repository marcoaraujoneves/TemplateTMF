                            ...
                            <div class="col-md-6 text-center wrap">
                                <div class="card tile">
                                    <img src="img/prod.png" alt="Avatar" class="img_prod">
                                                ...
                                                <p class="animate-text">Bacon ipsum dolor amet pork belly tri-tip turducken, pancetta bresaola pork chicken meatloaf. Flank sirloin strip steak prosciutto kevin turducken. </p><!--Suporta at̩ 168 caracteres. Descri̤̣o-->
                                </div>
                            </div>
                            <div class="col-md-6 text-center wrap">
                                <div class="card tile">
                                    <img src="img/prod.png" alt="Avatar" class="img_prod">
                                                ...
                                                <p class="animate-text">Bacon ipsum dolor amet pork belly tri-tip turducken, pancetta bresaola pork chicken meatloaf. Flank sirloin strip steak prosciutto kevin turducken. </p><!--Suporta at̩ 168 caracteres-->         
                                </div>
                            </div>
                        </div>
                    </div>
