    <div class="container-fluid d-none d-md-block" id="bg">
            <div class="row">
                <div class="col-md-4">
                    <p class="textomenu">(22)9999-8756<br><br>07h até as 17h</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="img/logo.png" id="logo">
                </div>
                <div class="col-md-4">       
                    <p class="textomenu">contato@gmail.com<br><br><a target="_blank" href="#"><img class="social_icone" src="img/fb.png"></a>
                    <a target="_blank" href="#"><img class="social_icone" src="img/ig.png"></a></p>
        ...
        <div class="container sticky-top">
            ...
            <div class="collapse navbar-collapse" id="menu-navegacao">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item navegacao"><a class="nav-link" href="#">Contatos</a></li>
                </ul>
            </div>
        </div>
    </nav>